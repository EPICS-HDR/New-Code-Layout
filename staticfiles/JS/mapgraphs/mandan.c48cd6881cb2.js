...
.then(data => {
  ...
  const layout1 = {
    title: 'Mandan Elevation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Elevation'}
  };

  /* Create the first plot */
  Plotly.newPlot('Mandan Elevation', [graph1], layout1);
  ...
  Plotly.newPlot('Mandan Elevation Table', [table1], tableLayout);
  ...
  const layout2 = {
    title: 'Mandan Gauge Height',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Gauge Height'}
  };

  /* Create the second plot */
  Plotly.newPlot('Mandan Gauge Height', [graph2], layout2);
  ...
  Plotly.newPlot('Mandan Gauge Height Table', [table2], tableLayout);
  ...
  const layout3 = {
    title: 'Mandan Discharge',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Discharge'}
  };
  
  /* Create the third plot */
  Plotly.newPlot('Mandan Discharge', [graph3], layout3);
  ...
  Plotly.newPlot('Mandan Discharge Table', [table3], tableLayout);
})
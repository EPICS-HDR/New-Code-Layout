...
.then(data => {
  ...
  const layout1 = {
    title: 'Breien Elevation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Elevation'}
  };

  /* Create the first plot */
  Plotly.newPlot('Breien Elevation', [graph1], layout1);
  ...
  Plotly.newPlot('Breien Elevation Table', [table1], tableLayout);
  ...
  const layout2 = {
    title: 'Breien Gauge Height',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Gauge Height'}
  };

  /* Create the second plot */
  Plotly.newPlot('Breien Gauge Height', [graph2], layout2);
  ...
  Plotly.newPlot('Breien Gauge Height Table', [table2], tableLayout);
  ...
  const layout3 = {
    title: 'Breien Discharge',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Discharge'}
  };

  /* Create the third plot */
  Plotly.newPlot('Breien Discharge', [graph3], layout3);
  ...
  Plotly.newPlot('Breien Discharge Table', [table3], tableLayout);
})
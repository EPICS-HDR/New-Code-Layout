...
.then(data => {
  ...
  const layout1 = {
    title: 'Little Eagle Gauge Height',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Gauge Height'}
  };

  /* Create the first plot */
  Plotly.newPlot('Little Eagle Gauge Height', [graph1], layout1);
  ...
  Plotly.newPlot('Little Eagle Gauge Height Table', [table1], tableLayout);
  ...
  const layout2 = {
    title: 'Little Eagle Discharge',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Discharge'}
  };

  /* Create the second plot */
  Plotly.newPlot('Little Eagle Discharge', [graph2], layout2);
  ...
  Plotly.newPlot('Little Eagle Discharge Table', [table2], tableLayout);
})
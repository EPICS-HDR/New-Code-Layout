...
.then(data => {
  ...
  const layoutElevation = {
    title: 'Gavins Point Elevation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Elevation'}
  };
  Plotly.newPlot('Gavins Point Elevation', [graphElevation], layoutElevation);
  ...
  Plotly.newPlot('Gavins Point Elevation Table', [table1], tableLayout);
  ...
  const layoutFlowSpill = {
    title: 'Gavins Point Flow Spill',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Flow Spill'},
  };
  Plotly.newPlot('Gavins Point Flow Spill', [graphFlowSpill], layoutFlowSpill);
  ...
  Plotly.newPlot('Gavins Point Flow Spill Table', [table2], tableLayout);
  ...
  const layoutFlowPowerhouse = {
    title: 'Gavins Point Flow Powerhouse',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Flow Powerhouse'}
  };
  Plotly.newPlot('Gavins Point Flow Powerhouse', [graphFlowPowerhouse], layoutFlowPowerhouse);
  ...
  Plotly.newPlot('Gavins Point Flow Powerhouse Table', [table3], tableLayout);
  ...
  const layoutFlowOut = {
    title: 'Gavins Point Flow Out',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Flow Out'}
  };
  Plotly.newPlot('Gavins Point Flow Out', [graphFlowOut], layoutFlowOut);
  ...
  Plotly.newPlot('Gavins Point Flow Out Table', [table4], tableLayout);
  ...
  const layoutElevTailwater = {
    title: 'Gavins Point Tailwater Elevation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Elevation'}
  };
  Plotly.newPlot('Gavins Point Tailwater Elevation', [graphElevTailwater], layoutElevTailwater);
  ...
  Plotly.newPlot('Gavins Point Tailwater Elevation Table', [table5], tableLayout);
  ...
  const layoutEnergy = {
    title: 'Gavins Point Energy',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Energy'}
  };
  Plotly.newPlot('Gavins Point Energy', [graphEnergy], layoutEnergy);
  ...
  Plotly.newPlot('Gavins Point Energy Table', [table6], tableLayout);
  ...
  const layoutTempWater = {
    title: 'Gavins Point Water Temperature',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Temperature'}
  };
  Plotly.newPlot('Gavins Point Water Temperature', [graphTempWater], layoutTempWater);
  ...
  Plotly.newPlot('Gavins Point Water Temperature Table', [table7], tableLayout);
  ...
  const layoutTempAir = {
    title: 'Gavins Point Air Temperature',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Temperature'}
  };
  Plotly.newPlot('Gavins Point Air Temperature', [graphTempAir], layoutTempAir);
  ...
  Plotly.newPlot('Gavins Point Air Temperature Table', [table8], tableLayout);
})
...
.then(data => {
  ...
  const layoutElevation = {
    title: 'Fort Peck Elevation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Elevation'}
  };
  Plotly.newPlot('Fort Peck Elevation', [graphElevation], layoutElevation);
  ...
  Plotly.newPlot('Fort Peck Elevation Table', [tableElevation], tableLayout);
  ...
  const layoutFlowSpill = {
    title: 'Fort Peck Flow Spill',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Flow Spill'}
  };
  Plotly.newPlot('Fort Peck Flow Spill', [graphFlowSpill], layoutFlowSpill);
  ...
  Plotly.newPlot('Fort Peck Flow Spill Table', [tableFlowSpill], tableLayout);
  ...
  const layoutFlowPowerhouse = {
    title: 'Fort Peck Flow Powerhouse',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Flow Powerhouse'}
  };
  Plotly.newPlot('Fort Peck Flow Powerhouse', [graphFlowPowerhouse], layoutFlowPowerhouse);
  ...
  Plotly.newPlot('Fort Peck Flow Powerhouse Table', [tableFlowPowerhouse], tableLayout);
  ...
  const layoutFlowOut = {
    title: 'Fort Peck Flow Out',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Flow Out'}
  };
  Plotly.newPlot('Fort Peck Flow Out', [graphFlowOut], layoutFlowOut);
  ...
  Plotly.newPlot('Fort Peck Flow Out Table', [tableFlowOut], tableLayout);
  ...
  const layoutElevTailwater = {
    title: 'Fort Peck Tailwater Elevation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Tailwater Elevation'}
  };
  Plotly.newPlot('Fort Peck Tailwater Elevation', [graphElevTailwater], layoutElevTailwater);
  ...
  Plotly.newPlot('Fort Peck Tailwater Elevation Table', [tableElevTailwater], tableLayout);
  ...
  const layoutEnergy = {
    title: 'Fort Peck Energy',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Energy'}
  };
  Plotly.newPlot('Fort Peck Energy', [graphEnergy], layoutEnergy);
  ...
  Plotly.newPlot('Fort Peck Energy Table', [tableEnergy], tableLayout);
  ...
  const layoutTempWater = {
    title: 'Fort Peck Water Temperature',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Temperature'}
  };
  Plotly.newPlot('Fort Peck Water Temperature', [graphTempWater], layoutTempWater);
  ...
  Plotly.newPlot('Fort Peck Water Temperature Table', [tableTempWater], tableLayout);
  ...
  const layoutTempAir = {
    title: 'Fort Peck Air Temperature',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Temperature'}
  };
  Plotly.newPlot('Fort Peck Air Temperature', [graphTempAir], layoutTempAir);
  ...
  Plotly.newPlot('Fort Peck Air Temperature Table', [tableTempAir], tableLayout);
})
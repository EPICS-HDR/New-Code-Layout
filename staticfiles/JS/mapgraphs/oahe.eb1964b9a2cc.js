...
.then(data => {
  ...
  const layoutElevation = {
    title: 'Oahe Elevation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Elevation'}
  };
  Plotly.newPlot('Oahe Elevation', [graphElevation], layoutElevation);
  ...
  Plotly.newPlot('Oahe Elevation Table', [table1], tableLayout);
  ...
  const layoutFlowSpill = {
    title: 'Oahe Flow Spill',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Flow Spill'}
  };
  Plotly.newPlot('Oahe Flow Spill', [graphFlowSpill], layoutFlowSpill);
  ...
  Plotly.newPlot('Oahe Flow Spill Table', [table2], tableLayout);
  ...
  const layoutFlowPowerhouse = {
    title: 'Oahe Flow Powerhouse',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Flow Powerhouse'}
  };
  Plotly.newPlot('Oahe Flow Powerhouse', [graphFlowPowerhouse], layoutFlowPowerhouse);
  ...
  Plotly.newPlot('Oahe Flow Powerhouse Table', [table3], tableLayout);
  ...
  Plotly.newPlot('Oahe Flow Out', [graphFlowOut], layoutFlowOut);
  ...
  Plotly.newPlot('Oahe Flow Out Table', [table4], tableLayout);
  ...
  const layoutElevTailwater = {
    title: 'Oahe Tailwater Elevation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Elevation'}
  };
  Plotly.newPlot('Oahe Tailwater Elevation', [graphElevTailwater], layoutElevTailwater);
  ...
  Plotly.newPlot('Oahe Tailwater Elevation Table', [table5], tableLayout);
  ...
  Plotly.newPlot('Oahe Energy', [graphEnergy], layoutEnergy);
  ...
  Plotly.newPlot('Oahe Energy Table', [table6], tableLayout);
  ...
  const layoutTempWater = {
    title: 'Oahe Water Temperature',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Temperature'}
  };
  Plotly.newPlot('Oahe Water Temperature', [graphTempWater], layoutTempWater);
  ...
  Plotly.newPlot('Oahe Water Temperature Table', [table7], tableLayout);
  ...
  const layoutTempAir = {
    title: 'Oahe Air Temperature',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Temperature'}
  };
  Plotly.newPlot('Oahe Air Temperature', [graphTempAir], layoutTempAir);
  ...
  Plotly.newPlot('Oahe Air Temperature Table', [table8], tableLayout);
})
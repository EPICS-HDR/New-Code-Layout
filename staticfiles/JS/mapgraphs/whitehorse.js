...
.then(data => {
  ...
  const layout1 = {
    title: 'Whitehorse Gauge Height',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Gauge Height'}
  };

  /* Create the first plot */
  Plotly.newPlot('Whitehorse Gauge Height', [graph1], layout1);
  ...
  Plotly.newPlot('Whitehorse Gauge Height Table', [table1], tableLayout);
  ...
  const layout2 = {
    title: 'Whitehorse Discharge',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Discharge'}
  };

  /* Create the second plot */
  Plotly.newPlot('Whitehorse Discharge', [graph2], layout2);
  ...
  Plotly.newPlot('Whitehorse Discharge Table', [table2], tableLayout);
})
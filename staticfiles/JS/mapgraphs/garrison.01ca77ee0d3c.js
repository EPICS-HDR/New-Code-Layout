...
.then(data => {
  ...
  const layoutElevation = {
    title: 'Garrison Elevation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Elevation'}
  };
  Plotly.newPlot('Garrison Elevation', [graphElevation], layoutElevation);
  ...
  Plotly.newPlot('Garrison Elevation Table', [table1], tableLayout);
  ...
  const layoutFlowSpill = {
    title: 'Garrison Flow Spill',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Flow Spill'}
  };
  Plotly.newPlot('Garrison Flow Spill', [graphFlowSpill], layoutFlowSpill);
  ...
  Plotly.newPlot('Garrison Flow Spill Table', [table2], tableLayout);
  ...
  const layoutFlowPowerhouse = {
    title: 'Garrison Flow Powerhouse',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Flow Powerhouse'}
  };
  Plotly.newPlot('Garrison Flow Powerhouse', [graphFlowPowerhouse], layoutFlowPowerhouse);
  ...
  Plotly.newPlot('Garrison Flow Powerhouse Table', [table3], tableLayout);
  ...
  const layoutFlowOut = {
    title: 'Garrison Flow Out',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Flow Out'}
  };
  Plotly.newPlot('Garrison Flow Out', [graphFlowOut], layoutFlowOut);
  ...
  Plotly.newPlot('Garrison Flow Out Table', [table4], tableLayout);
  ...
  const layoutElevTailwater = {
    title: 'Garrison Tailwater Elevation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Elevation'}
  };
  Plotly.newPlot('Garrison Tailwater Elevation', [graphElevTailwater], layoutElevTailwater);
  ...
  Plotly.newPlot('Garrison Tailwater Elevation Table', [table5], tableLayout);
  ...
  const layoutEnergy = {
    title: 'Garrison Energy',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Energy'}
  };
  Plotly.newPlot('Garrison Energy', [graphEnergy], layoutEnergy);
  ...
  Plotly.newPlot('Garrison Energy Table', [table6], tableLayout);
  ...
  const layoutTempWater = {
    title: 'Garrison Water Temperature',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Temperature'}
  };
  Plotly.newPlot('Garrison Water Temperature', [graphTempWater], layoutTempWater);
  ...
  Plotly.newPlot('Garrison Water Temperature Table', [table7], tableLayout);
  ...
  const layoutTempAir = {
    title: 'Garrison Air Temperature',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Temperature'}
  };
  Plotly.newPlot('Garrison Air Temperature', [graphTempAir], layoutTempAir);
  ...
  Plotly.newPlot('Garrison Air Temperature Table', [table8], tableLayout);
})

document.addEventListener("DOMContentLoaded", function () {
  const toggleButton = document.getElementById("showgraph1");
  const graphContainer = document.getElementById("Garrison Plot1");
...
document.addEventListener("DOMContentLoaded", function () {
  const toggleButton = document.getElementById("showgraph2");
  const graphContainer = document.getElementById("Garrison Plot2");
...
document.addEventListener("DOMContentLoaded", function () {
  const toggleButton = document.getElementById("showgraph3");
  const graphContainer = document.getElementById("Garrison Plot3");
...
document.addEventListener("DOMContentLoaded", function () {
  const toggleButton = document.getElementById("showgraph4");
  const graphContainer = document.getElementById("Garrison Plot4");
...
document.addEventListener("DOMContentLoaded", function () {
  const toggleButton = document.getElementById("showgraph5");
  const graphContainer = document.getElementById("Garrison Plot5");
...
document.addEventListener("DOMContentLoaded", function () {
  const toggleButton = document.getElementById("showgraph6");
  const graphContainer = document.getElementById("Garrison Plot6");
...
document.addEventListener("DOMContentLoaded", function () {
  const toggleButton = document.getElementById("showgraph7");
  const graphContainer = document.getElementById("Garrison Plot7");
...
document.addEventListener("DOMContentLoaded", function () {
  const toggleButton = document.getElementById("showgraph8");
  const graphContainer = document.getElementById("Garrison Plot8");

...
.then(data => {
  ...
  const layout1 = {
    title: 'Hazen Elevation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Elevation'}
  };

  /* Create the first plot */
  Plotly.newPlot('Hazen Elevation', [graph1], layout1);
  ...
  Plotly.newPlot('Hazen Elevation Table', [table1], tableLayout);
  ...
  const layout2 = {
    title: 'Hazen Gauge Height',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Gauge Height'}
  };

  /* Create the second plot */
  Plotly.newPlot('Hazen Gauge Height', [graph2], layout2);
  ...
  Plotly.newPlot('Hazen Gauge Height Table', [table2], tableLayout);
  ...
  const layout3 = {
    title: 'Hazen Discharge',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Discharge'}
  };

  /* Create the third plot */
  Plotly.newPlot('Hazen Discharge', [graph3], layout3);
  ...
  Plotly.newPlot('Hazen Discharge Table', [table3], tableLayout);
})
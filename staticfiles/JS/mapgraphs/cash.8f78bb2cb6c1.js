...
.then(data => {
  ...
  const layout1 = {
    title: 'Cash Gauge Height',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Gauge Height'}
  };

  /* Create the first plot */
  Plotly.newPlot('Cash Gauge Height', [graph1], layout1);
  ...
  Plotly.newPlot('Cash Gauge Height Table', [table1], tableLayout);
  ...
  const layout2 = {
    title: 'Cash Discharge',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Discharge'}
  };

  /* Create the second plot */
  Plotly.newPlot('Cash Discharge', [graph2], layout2);
  ...
  Plotly.newPlot('Cash Discharge Table', [table2], tableLayout);
})
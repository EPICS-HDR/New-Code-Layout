...
.then(data => {
  ...
  const layoutAirTemp = {
    title: 'Fort Yates Average Air Temperature',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Degrees Fahrenheit'}
  };
  Plotly.newPlot('Fort Yates Average Air Temperature', [graphAirTemp], layoutAirTemp);
  ...
  Plotly.newPlot('Fort Yates Average Air Temperature Table', [tableAirTemp], tableLayout);
  ...
  const layoutRelativeHumidity = {
    title: 'Fort Yates Average Relative Humidity',
    xaxis: {title: 'Time'},
    yaxis: {title: '% Humidity'}
  };
  Plotly.newPlot('Fort Yates Average Relative Humidity', [graphRelativeHumidity], layoutRelativeHumidity);
  ...
  Plotly.newPlot('Fort Yates Average Relative Humidity Table', [tableRelativeHumidity], tableLayout);
  ...
  const layoutAverageBareSoil = {
    title: 'Fort Yates Average Bare Soil Temperature',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Degrees Fahrenheit'}
  };
  Plotly.newPlot('Fort Yates Average Bare Soil Temperature', [graphAverageBareSoil], layoutAverageBareSoil);
  ...
  Plotly.newPlot('Fort Yates Average Bare Soil Temperature Table', [tableAverageBareSoil], tableLayout);
  ...
  const layoutAverageTurfSoil = {
    title: 'Fort Yates Average Turf Soil Temperature',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Degrees Fahrenheit'}
  };
  Plotly.newPlot('Fort Yates Average Turf Soil Temperature', [graphAverageTurfSoil], layoutAverageTurfSoil);
  ...
  Plotly.newPlot('Fort Yates Average Turf Soil Temperature Table', [tableAverageTurfSoil], tableLayout);
  ...
  const layoutMaxWind = {
    title: 'Fort Yates Max Wind Speed',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Miles Per Hour'}
  };
  Plotly.newPlot('Fort Yates Max Wind Speed', [graphMaxWind], layoutMaxWind);
  ...
  Plotly.newPlot('Fort Yates Max Wind Speed Table', [tableMaxWind], tableLayout);
  ...
  const layoutAvgWindDir = {
    title: 'Fort Yates Average Wind Direction',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Degrees'}
  };
  Plotly.newPlot('Fort Yates Average Wind Direction', [graphAvgWindDir], layoutAvgWindDir);
  ...
  Plotly.newPlot('Fort Yates Average Wind Direction Table', [tableAvgWindDir], tableLayout);
  ...
  const layoutTotalSR = {
    title: 'Fort Yates Total Solar Radiation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Langleys'}
  };
  Plotly.newPlot('Fort Yates Total Solar Radiation', [graphTotalSR], layoutTotalSR);
  ...
  Plotly.newPlot('Fort Yates Total Solar Radiation Table', [tableTotalSR], tableLayout);
  ...
  const layoutRainfall = {
    title: 'Fort Yates Total Rainfall',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Inches'}
  };
  Plotly.newPlot('Fort Yates Total Rainfall', [graphRainfall], layoutRainfall);
  ...
  Plotly.newPlot('Fort Yates Total Rainfall Table', [tableRainfall], tableLayout);
  ...
  const layoutBaroPres = {
    title: 'Fort Yates Average Barometric Pressure',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Millibars'}
  };
  Plotly.newPlot('Fort Yates Average Barometric Pressure', [graphBaroPres], layoutBaroPres);
  ...
  Plotly.newPlot('Fort Yates Average Barometric Pressure Table', [tableBaroPres], tableLayout);
  ...
  const layoutAvgDew = {
    title: 'Fort Yates Average Dew Point',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Degrees Fahrenheit'}
  };
  Plotly.newPlot('Fort Yates Average Dew Point', [graphAvgDew], layoutAvgDew);
  ...
  Plotly.newPlot('Fort Yates Average Dew Point Table', [tableAvgDew], tableLayout);
  ...
  const layoutAvgWindChill = {
    title: 'Fort Yates Average Wind Chill',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Degrees Fahrenheit'}
  };
  Plotly.newPlot('Fort Yates Average Wind Chill', [graphAvgWindChill], layoutAvgWindChill);
  ...
  Plotly.newPlot('Fort Yates Average Wind Chill Table', [tableAvgWindChill], tableLayout);
})
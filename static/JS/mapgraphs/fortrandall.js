...
.then(data => {
  ...
  const layoutElevation = {
    title: 'Fort Randall Elevation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Elevation'}
  };
  Plotly.newPlot('Fort Randall Elevation', [graphElevation], layoutElevation);
  ...
  Plotly.newPlot('Fort Randall Elevation Table', [tableElevation], tableLayout);
  ...
  const layoutFlowSpill = {
    title: 'Fort Randall Flow Spill',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Flow Spill'}
  };
  Plotly.newPlot('Fort Randall Flow Spill', [graphFlowSpill], layoutFlowSpill);
  ...
  Plotly.newPlot('Fort Randall Flow Spill Table', [tableFlowSpill], tableLayout);
  ...
  const layoutFlowPowerhouse = {
    title: 'Fort Randall Flow Powerhouse',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Flow Powerhouse'}
  };
  Plotly.newPlot('Fort Randall Flow Powerhouse', [graphFlowPowerhouse], layoutFlowPowerhouse);
  ...
  Plotly.newPlot('Fort Randall Flow Powerhouse Table', [tableFlowPowerhouse], tableLayout);
  ...
  const layoutFlowOut = {
    title: 'Fort Randall Flow Out',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Flow Out'}
  };
  Plotly.newPlot('Fort Randall Flow Out', [graphFlowOut], layoutFlowOut);
  ...
  Plotly.newPlot('Fort Randall Flow Out Table', [tableFlowOut], tableLayout);
  ...
  const layoutElevTailwater = {
    title: 'Fort Randall Tailwater Elevation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Elevation'}
  };
  Plotly.newPlot('Fort Randall Tailwater Elevation', [graphElevTailwater], layoutElevTailwater);
  ...
  Plotly.newPlot('Fort Randall Tailwater Elevation Table', [tableElevTailwater], tableLayout);
  ...
  const layoutEnergy = {
    title: 'Fort Randall Energy',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Energy'}
  };
  Plotly.newPlot('Fort Randall Energy', [graphEnergy], layoutEnergy);
  ...
  Plotly.newPlot('Fort Randall Energy Table', [tableEnergy], tableLayout);
  ...
  const layoutTempWater = {
    title: 'Fort Randall Water Temperature',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Temperature'}
  };
  Plotly.newPlot('Fort Randall Water Temperature', [graphTempWater], layoutTempWater);
  ...
  Plotly.newPlot('Fort Randall Water Temperature Table', [tableTempWater], tableLayout);
  ...
  const layoutTempAir = {
    title: 'Fort Randall Air Temperature',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Temperature'}
  };
  Plotly.newPlot('Fort Randall Air Temperature', [graphTempAir], layoutTempAir);
  ...
  Plotly.newPlot('Fort Randall Air Temperature Table', [tableTempAir], tableLayout);
})
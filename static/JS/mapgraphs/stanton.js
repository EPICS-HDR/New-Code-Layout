...
.then(data => {
  ...
  const layout1 = {
    title: 'Stanton Elevation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Elevation'}
  };

  /* Create the first plot */
  Plotly.newPlot('Stanton Elevation', [graph1], layout1);
  ...
  Plotly.newPlot('Stanton Elevation Table', [table1], tableLayout);
  ...
  const layout2 = {
    title: 'Stanton Gauge Height',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Gauge Height'}
  };

  /* Create the second plot */
  Plotly.newPlot('Stanton Gauge Height', [graph2], layout2);
  ...
  Plotly.newPlot('Stanton Gauge Height Table', [table2], tableLayout);
})
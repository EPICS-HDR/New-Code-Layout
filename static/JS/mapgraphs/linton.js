...
.then(data => {
  ...
  const layoutAirTemp = {
    title: 'Linton Average Air Temperature',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Degrees Fahrenheit'}
  };
  Plotly.newPlot('Linton Average Air Temperature', [graphAirTemp], layoutAirTemp);
  ...
  Plotly.newPlot('Linton Average Air Temperature Table', [table1], tableLayout);
  ...
  const layoutRelativeHumidity = {
    title: 'Linton Average Relative Humidity',
    xaxis: {title: 'Time'},
    yaxis: {title: '% Humidity'}
  };
  Plotly.newPlot('Linton Average Relative Humidity', [graphRelativeHumidity], layoutRelativeHumidity);
  ...
  Plotly.newPlot('Linton Average Relative Humidity Table', [table2], tableLayout);
  ...
  const layoutAverageBareSoil = {
    title: 'Linton Average Bare Soil Temperature',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Degrees Fahrenheit'}
  };
  Plotly.newPlot('Linton Average Bare Soil Temperature', [graphAverageBareSoil], layoutAverageBareSoil);
  ...
  Plotly.newPlot('Linton Average Bare Soil Temperature Table', [table3], tableLayout);
  ...
  const layoutAverageTurfSoil = {
    title: 'Linton Average Turf Soil Temperature',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Degrees Fahrenheit'}
  };
  Plotly.newPlot('Linton Average Turf Soil Temperature', [graphAverageTurfSoil], layoutAverageTurfSoil);
  ...
  Plotly.newPlot('Linton Average Turf Soil Temperature Table', [table4], tableLayout);
  ...
  const layoutMaxWind = {
    title: 'Linton Max Wind Speed',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Miles Per Hour'}
  };
  Plotly.newPlot('Linton Max Wind Speed', [graphMaxWind], layoutMaxWind);
  ...
  Plotly.newPlot('Linton Max Wind Speed Table', [table5], tableLayout);
  ...
  const layoutAvgWindDir = {
    title: 'Linton Average Wind Direction',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Degrees'}
  };
  Plotly.newPlot('Linton Average Wind Direction', [graphAvgWindDir], layoutAvgWindDir);
  ...
  Plotly.newPlot('Linton Average Wind Direction Table', [table6], tableLayout);
  ...
  const layoutTotalSR = {
    title: 'Linton Total Solar Radiation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Langleys'}
  };
  Plotly.newPlot('Linton Total Solar Radiation', [graphTotalSR], layoutTotalSR);
  ...
  Plotly.newPlot('Linton Total Solar Radiation Table', [table7], tableLayout);
  ...
  const layoutRainfall = {
    title: 'Linton Total Rainfall',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Inches'}
  };
  Plotly.newPlot('Linton Total Rainfall', [graphRainfall], layoutRainfall);
  ...
  Plotly.newPlot('Linton Total Rainfall Table', [table8], tableLayout);
  ...
  const layoutBaroPres = {
    title: 'Linton Average Barometric Pressure',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Millibars'}
  };
  Plotly.newPlot('Linton Average Barometric Pressure', [graphBaroPres], layoutBaroPres);
  ...
  Plotly.newPlot('Linton Average Barometric Pressure Table', [table9], tableLayout);
  ...
  const layoutAvgDew = {
    title: 'Linton Average Dew Point',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Degrees Fahrenheit'}
  };
  Plotly.newPlot('Linton Average Dew Point', [graphAvgDew], layoutAvgDew);
  ...
  Plotly.newPlot('Linton Average Dew Point Table', [table10], tableLayout);
  ...
  const layoutAvgWindChill = {
    title: 'Linton Average Wind Chill',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Degrees Fahrenheit'}
  };
  Plotly.newPlot('Linton Average Wind Chill', [graphAvgWindChill], layoutAvgWindChill);
  ...
  Plotly.newPlot('Linton Average Wind Chill Table', [table11], tableLayout);
})
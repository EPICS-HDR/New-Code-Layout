...
.then(data => {
  ...
  const layout1 = {
    title: 'Price Elevation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Elevation'}
  };

  /* Create the first plot */
  Plotly.newPlot('Price Elevation', [graph1], layout1);
  ...
  Plotly.newPlot('Price Elevation Table', [table1], tableLayout);
  ...
  const layout2 = {
    title: 'Price Gauge Height',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Gauge Height'}
  };

  /* Create the second plot */
  Plotly.newPlot('Price Gauge Height', [graph2], layout2);
  ...
  Plotly.newPlot('Price Gauge Height Table', [table2], tableLayout);  
})
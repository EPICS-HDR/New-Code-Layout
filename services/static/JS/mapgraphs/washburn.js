...
.then(data => {
  ...
  const layout1 = {
    title: 'Washburn Elevation',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Elevation'}
  };

  /* Create the first plot */
  Plotly.newPlot('Washburn Elevation', [graph1], layout1);
  ...
  Plotly.newPlot('Washburn Elevation Table', [table1], tableLayout);
  ...
  const layout2 = {
    title: 'Washburn Gauge Height',
    xaxis: {title: 'Time'},
    yaxis: {title: 'Gauge Height'}
  };

  /* Create the second plot */
  Plotly.newPlot('Washburn Gauge Height', [graph2], layout2);
  ...
  Plotly.newPlot('Washburn Gauge Height Table', [table2], tableLayout);
})
...
if (text[i] === 'NF Grand River near Cash SD') {
// Add click event listener to the marker
marker.getElement().addEventListener('click', function() {
  // Close any open modals
  closeModal();
...
// Get the modal and the close button
var modal = document.getElementById('Cash');
var closeButton = modal.querySelector('.close');
...
if (text[i] === 'Oak Creek at Wakpala') {
// Add click event listener to the marker
marker.getElement().addEventListener('click', function() {
  // Close any open modals
  closeModal();
...
// Get the modal and the close button
var modal = document.getElementById('Wakpala');
var closeButton = modal.querySelector('.close');
...
if (text[i] === 'Moreau River near Whitehorse SD') {
// Add click event listener to the marker
marker.getElement().addEventListener('click', function() {
  // Close any open modals
  closeModal();
...
// Get the modal and the close button
var modal = document.getElementById('Whitehorse');
var closeButton = modal.querySelector('.close');
...
if (text[i] === 'Grand River near Little Eagle SD') {
// Add click event listener to the marker
marker.getElement().addEventListener('click', function() {
  // Close any open modals
  closeModal();
...
// Get the modal and the close button
var modal = document.getElementById('Little Eagle');
var closeButton = modal.querySelector('.close');
